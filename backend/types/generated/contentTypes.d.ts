...
export interface ApiCurriculumSectionCurriculumSection
  ...
  info: {
    ...
    pluralName: 'curriculum-sections';
    singularName: 'curriculum-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    diploma_1_desc: Schema.Attribute.String;
    diploma_1_title: Schema.Attribute.String;
    diploma_2_desc: Schema.Attribute.String;
    diploma_2_title: Schema.Attribute.String;
    eyebrow: Schema.Attribute.String;
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    badge_scribble: Schema.Attribute.String;
    ...
    stat_1_value: Schema.Attribute.String;
    stat_2_label: Schema.Attribute.String;
    stat_2_value: Schema.Attribute.String;
...
export interface ApiLifeTileLifeTile extends Struct.CollectionTypeSchema {
  collectionName: 'life_tiles';
  info: {
    displayName: 'Life Tile';
    pluralName: 'life-tiles';
    singularName: 'life-tile';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    tile_type: Schema.Attribute.Enumeration<
      ['classroom', 'uniform', 'ipad', 'asrama']
    >;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRegistrationRegistration
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    minat: Schema.Attribute.String & Schema.Attribute.Required;
    nama: Schema.Attribute.String & Schema.Attribute.Required;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    smp: Schema.Attribute.String & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<
      ['baru', 'dihubungi', 'diterima', 'ditolak']
    > &
...
export interface ApiSubjectSubject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['creative', 'academic']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTimelineStepTimelineStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'timeline_steps';
  info: {
    displayName: 'Timeline Step';
    pluralName: 'timeline-steps';
    singularName: 'timeline-step';
  };
  options: {
    draftAndPublish: true;
  };
